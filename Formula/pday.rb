class Pday < Formula
  ...
  desc "AI-powered daily planning assistant"
  homepage "https://github.com/ibtisamdev/planmyday"
  url "https://files.pythonhosted.org/packages/2e/a0/46296654fcb50ca6514587cccd36ae3802b40a4a630f72f0628a177b1c6a/planmyday-0.1.0.tar.gz"
  sha256 "2635c587e388bd84e3c5e6bb5b98b7216db97d977fb8d9d341ce66340a1e8a78"
  license "MIT"
  ...
  test do
    assert_match version.to_s, shell_output("#{bin}/pday --version")
  end
end
